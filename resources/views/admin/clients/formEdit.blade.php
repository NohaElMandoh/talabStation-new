                ...
                <form enctype="multipart/form-data">
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-12">
                            <div class="position-relative form-group"><label for="exampleName" class="">اسم العميل</label>
                                <input name="name" id="name" value='{{$client->name}}' value='{{$client->name}}' type="text" class="form-control"></div>
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-6">
                            <div class="position-relative form-group"><label for="exampleAddress" class="">التليفون</label>
                                <input name="home_phone" id="home_phone" value='{{$client->home_phone}}'  type="text" class="form-control"></div>

                        </div>
                        <div class="col-md-6">
                            <div class="position-relative form-group"><label for="exampleAddress" class="">الموبايل</label>
                                <input name="phone" id="phone" value='{{$client->phone}}'  type="text" class="form-control"></div>
                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="position-relative form-group"><label for="exampleAddress" class="">البريد الالكترونى</label>
                                <input type="email" name="email" id="email" value='{{$client->email}}'type="text" class="form-control"></div>

                        </div>
                        <div class="col-md-6">
                            <div class="position-relative form-group"><label for="exampleAddress" class="">العنوان</label>
                                <input name="address" id="address" value='{{$client->address}}'type="text" class="form-control"></div>
                        ...
                        <div class="col-md-6">
                            <div class="position-relative form-group"><label for="region_id" class="">المنطقة</label>
                                <select class="form-control" id='region_id' name='region_id'>
                                    ...
                                    <option value="{{$region->id}}" @if($client->region_id == $region->id) selected @endif >{{$region->name_ar}}</option>
                                    @endforeach
                                    @endif
                                </select>
                            </div>
                    ...
                    <div class="col-md-6">
                            <div class="position-relative form-group"><label for="type_id" class="">المحافظة</label>
                                <select class="form-control" id='city_id' name='city_id'>
                                    ...
                                    <option value="{{$city->id}}" @if($client->region->city->id == $city->id) selected @endif >{{$city->name_ar}}</option>
                                    @endforeach
                                    @endif
                                </select>
                            </div>
                    ...
                    <div class="form-row">
                        <div class="col-md-6">
                            <div class="position-relative form-group"><label for="exampleAddress" class="">lat</label>
                                <input  name="lat" id="lat" value='{{$client->lat}}'type="text" class="form-control"></div>

                        </div>
                        <div class="col-md-6">
                            <div class="position-relative form-group"><label for="exampleAddress" class="">lang</label>
                                <input name="lang" id="lang" value='{{$client->lang}}'type="text" class="form-control"></div>
                    ...
                    <div class="form-row">
                        ...
                        <div id="client_image">
                            ...
                            <div class="img-prev">
                                <img class="img-thumbnails" src="{{url("public/".$client->photo)}}"></div>
                            @endif
                        </div>
                    ...
                    <div class="form-row">
                        ...
                        <button class="mt-1 btn btn-primary editClient">Submit</button>
                    </div>
                </form>
            </div>
        </div>
