...
<aside class="main-sidebar">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
           ...
           {{-- <li class="treeview">
                <a href="#"><i class="fa fa-cutlery"></i> <span>التجار</span> <i
                            class="fa fa-angle-left pull-left"></i></a>
                <ul class="treeview-menu">
                    <li><a href="{{url('admin/merchant')}}">عرض التجار</a></li>
                    @if( auth()->user()->hasRole('admin','editor') )<li><a href="{{url('admin/category')}}">تصنيفات التجار</a></li>@endif
                </ul>
            </li>
            <li class="treeview">
            ...
            <li class="treeview">
                <a href="#"><i class="fa fa-cutlery"></i> <span>المندوبين</span> <i
                            class="fa fa-angle-left pull-left"></i></a>
                <ul class="treeview-menu">
                    <li><a href="{{url('admin/runner')}}"> عرض المندوبين</a></li>
                </ul>
            </li>
          {{--  <li class="treeview">
                <a href="#"><i class="fa fa-cutlery"></i> <span>الوحدات</span> <i
                            class="fa fa-angle-left pull-left"></i></a>
                <ul class="treeview-menu">
                    <li><a href="{{url('admin/unit')}}"> عرض الوحدات</a></li>
                </ul>
            </li>
            ...
            <li><a href="{{url('admin/type')}}"><i class="fa fa-tags"></i> انواع التجار</a></li>
