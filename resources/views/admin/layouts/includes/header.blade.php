                ...
                <ul class="nav navbar-nav">
                    ...
                    {{--</li>--}}
						...
						<a href="#" id="notifications" data-toggle="dropdown" aria-haspopup="true">
							...
							<span class="count-label">{{Auth::user()->notificationCount()}}</span>
						</a>
							...
							<ul class="imp-notify">
								...
								<li>
									<div class="details" style="margin-left:0px;">
										<p><a href="{{url('/'.$noti->order_url)}}" id="markNoti" data-id="{{$noti->id}}">{{$noti->title}}</a></p>
									</div>
								</li>
								@endforeach
									...
									@elseif(Auth::user()->notificationCount() > 5)
										<li>
											<div class="details" style="margin-left:0px;">
												<p><a id="markAllNotiAsRead" style="color: blue;" href="">See All</a></p>
											</div>
										</li>
									@endif
							</ul>
