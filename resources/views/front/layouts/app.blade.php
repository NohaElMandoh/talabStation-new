<!DOCTYPE html>
<!-- saved from url=(0113)http://crazycafe.net/html/appiyan/home2.html?fbclid=IwAR2xzA04vFMVh4YCoww1P-ganSW5GMKrK_oHL9CfsQhaEzc98s1Q-jwQW8o -->
...
<body class="home2 loaded" data-new-gr-c-s-check-loaded="14.1014.0" data-gr-ext-installed="">
    ...
    <div id="home"></div>
    <!--  header area start -->
    <div id="sticky-wrapper" class="sticky-wrapper" style="height: 76px;"><div class="header-area" style="width: 1583px;">
        <div class="container">
            <div class="row">
                <div class="col-md-2">
                    <div class="logo cta">
                    ...
                    <div class="responsive_menu"><div class="slicknav_menu"><a href="http://crazycafe.net/html/appiyan/home2.html?fbclid=IwAR2xzA04vFMVh4YCoww1P-ganSW5GMKrK_oHL9CfsQhaEzc98s1Q-jwQW8o#" aria-haspopup="true" role="button" tabindex="0" class="slicknav_btn slicknav_collapsed" style="outline: none;"><span class="slicknav_menutxt"></span><span class="slicknav_icon slicknav_no-text"><span class="slicknav_icon-bar"></span><span class="slicknav_icon-bar"></span><span class="slicknav_icon-bar"></span></span></a><ul class="slicknav_nav slicknav_hidden" aria-hidden="true" role="menu" style="display: none;">
                            <li class="slicknav_collapsed slicknav_parent"><a href="http://crazycafe.net/html/appiyan/home2.html?fbclid=IwAR2xzA04vFMVh4YCoww1P-ganSW5GMKrK_oHL9CfsQhaEzc98s1Q-jwQW8o#" role="menuitem" aria-haspopup="true" tabindex="-1" class="slicknav_item slicknav_row" style="outline: none;"><a href="http://crazycafe.net/html/appiyan/home2.html?fbclid=IwAR2xzA04vFMVh4YCoww1P-ganSW5GMKrK_oHL9CfsQhaEzc98s1Q-jwQW8o#home" tabindex="-1">Home</a>
                                <span class="slicknav_arrow">►</span></a><ul class="drop-menu slicknav_hidden" role="menu" aria-hidden="true" style="display: none;">
                                    ...
                                    <li><a href="http://crazycafe.net/html/appiyan/home3.html" role="menuitem" tabindex="-1">Home 3</a></li>
                                    <li><a href="http://crazycafe.net/html/appiyan/home4.html" role="menuitem" tabindex="-1">Home 4</a></li>
                                    <li><a href="http://crazycafe.net/html/appiyan/home5.html" role="menuitem" tabindex="-1">Home 5</a></li>
                                    <li><a href="http://crazycafe.net/html/appiyan/home6.html" role="menuitem" tabindex="-1">Home 6</a></li>
                                    <li><a href="http://crazycafe.net/html/appiyan/home7.html" role="menuitem" tabindex="-1">Home 7</a></li>
                        ...
                        <ul id="nav">
                            <li><a href="http://crazycafe.net/html/appiyan/home2.html?fbclid=IwAR2xzA04vFMVh4YCoww1P-ganSW5GMKrK_oHL9CfsQhaEzc98s1Q-jwQW8o#home">Home</a>
                                <ul class="drop-menu">
                                    ...
                                    <li><a href="http://crazycafe.net/html/appiyan/home3.html">Home 3</a></li>
                                    <li><a href="http://crazycafe.net/html/appiyan/home4.html">Home 4</a></li>
                                    <li><a href="http://crazycafe.net/html/appiyan/home5.html">Home 5</a></li>
                                    <li><a href="http://crazycafe.net/html/appiyan/home6.html">Home 6</a></li>
                                    <li><a href="http://crazycafe.net/html/appiyan/home7.html">Home 7</a></li>
    ...
    <!--  hero area start -->
    <!--  about area start -->
    <div class="home2-about-area wow fadeInUp" id="about" style="visibility: visible; animation-name: fadeInUp;">
        <div class="container">
            <div class="row">
    ...
    <div class="home-2-featured-area" id="featured" style="display: none">
        <div class="container">
            <div class="row">
                <div class="col-lg-9 col-md-12 wow fadeInRight margin-left-30" style="visibility: visible; animation-name: fadeInRight;">
                    <div class="featured-right-item">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="featured-single-items">
                                    <div class="featured-single">
                                        <img src="{{asset('front/image/featured-icon1.png')}}" alt="">
                                    ...
                                    <div class="featured-single">
                                        <img src="{{asset('front/image/featured-icon2.png')}}" alt="">
                                        <div class="featured-single-text">
                                    ...
                                    <div class="featured-single">
                                        <img src="./Home 2 _ Appiyan - App Landing Page_files/featured-icon3.png" alt="">
                                        <div class="featured-single-text">
                                            <h4>Super Fast</h4>
                                            <p>Most such devices are sold with several
                                                <br> apps bundled as installed.</p>
                                    ...
                                    <div class="featured-single">
                                        <img src="./Home 2 _ Appiyan - App Landing Page_files/featured-icon4.png" alt="">
                                        <div class="featured-single-text">
                            ...
                            <div class="col-md-6">
                                <div class="featured-single-items">
                                    <div class="featured-single">
                                        <img src="./Home 2 _ Appiyan - App Landing Page_files/featured-icon5.png" alt="">
                                        <div class="featured-single-text">
                                    ...
                                    <div class="featured-single">
                                        <img src="./Home 2 _ Appiyan - App Landing Page_files/featured-icon6.png" alt="">
                                        <div class="featured-single-text">
                                    ...
                                    <div class="featured-single">
                                        <img src="./Home 2 _ Appiyan - App Landing Page_files/featured-icon7.png" alt="">
                                        <div class="featured-single-text">
                                    ...
                                    <div class="featured-single">
                                        <img src="./Home 2 _ Appiyan - App Landing Page_files/featured-icon8.png" alt="">
                                        <div class="featured-single-text">
                                            <h4>Extra Booster</h4>
                                            <p>Most such devices are sold with several
                                                <br> apps bundled as installed.</p>
                ...
                <div class="col-lg-3 wow fadeInLeft" style="visibility: visible; animation-name: fadeInLeft;">
                    <div class="featured-mobile pulse">
                        <img src="./Home 2 _ Appiyan - App Landing Page_files/featured-mobile.png" alt="">
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="screenshot-area cta2">
        <div class="container">
            <div class="row">
            ...
            <div class="row">
                <div class="col-lg-10 offset-lg-1 col-md-12">
                    <div class="home2-screenshot-slide owl-carousel owl-theme owl-responsive-992 owl-loaded">
                    ...
                    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-1880px, 0px, 0px); transition: all 0.25s ease 0s; width: 3133.33px;"><div class="owl-item cloned" style="width: 293.333px; margin-right: 20px;"><div class="home2-screenshot-single-slide">
                            ...
                            <img src="{{asset('front/image/home2-sc-1.jpg')}}" alt="">
                        </div></div><div class="owl-item" style="width: 293.333px; margin-right: 20px;"><div class="home2-screenshot-single-slide">
                            <img src="{{asset('front/image/home2-sc-2.jpg')}}" alt="">
                        </div></div><div class="owl-item" style="width: 293.333px; margin-right: 20px;"><div class="home2-screenshot-single-slide">
                            <img src="{{asset('front/image/home2-sc-3.jpg')}}" alt="">
                        </div></div><div class="owl-item active" style="width: 293.333px; margin-right: 20px;"><div class="home2-screenshot-single-slide">
                            <img src="{{asset('front/image/home2-sc-2.jpg')}}" alt="">
                        </div></div><div class="owl-item cloned active" style="width: 293.333px; margin-right: 20px;"><div class="home2-screenshot-single-slide">
                            <img src="{{asset('front/image/home2-sc-1.jpg')}}" alt="">
                        </div></div><div class="owl-item cloned active" style="width: 293.333px; margin-right: 20px;"><div class="home2-screenshot-single-slide">
                            <img src="{{asset('front/image/home2-sc-2.jpg')}}" alt="">
                        </div></div><div class="owl-item cloned active" style="width: 293.333px; margin-right: 20px;"><div class="home2-screenshot-single-slide">
                            <img src="{{asset('front/image/home2-sc-3.jpg')}}" alt="">
                        </div></div></div></div><div class="owl-controls"><div class="owl-nav"><div class="owl-prev" style=""><i class="zmdi zmdi-chevron-left"></i></div><div class="owl-next" style=""><i class="zmdi zmdi-chevron-right"></i></div></div><div class="owl-dots" style=""><div class="owl-dot"><span></span></div><div class="owl-dot active"><span></span></div></div></div></div>
                </div>
            </div>
        </div>
    </div>
    <!--  screenshot area end -->
    <!--  pricing area start -->
    <div class="pricng-area cta wow fadeInUp" id="pricing" style="visibility: visible; animation-name: fadeInUp;display: none">
        <div class="container">
            <div class="row">
    ...
    <!--  pricing area end -->
    <!--  counter area start -->
    <div class="counter-area cta wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;display: none">
        <div class="container">
            <div class="row">
    ...
    <div class="testimonial-area cta" id="testimonial" style="display: none">
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="testimonial-slide owl-carousel owl-theme owl-responsive-992 owl-loaded">
                        
                        
                        
                        
                    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2260px, 0px, 0px); transition: all 0.25s ease 0s; width: 3766.67px;"><div class="owl-item cloned" style="width: 356.667px; margin-right: 20px;"><div class="testimonial-single-slide">
                            ...
                            <div class="testimonial-slide-meta">
                                <img src="./Home 2 _ Appiyan - App Landing Page_files/testimonial-slide-meta2.png" alt="">
                        ...
                        </div></div><div class="owl-item cloned" style="width: 356.667px; margin-right: 20px;"><div class="testimonial-single-slide">
                            <div class="testimonial-slide-content">
                                <p>“Developing apps for mobile devices requires considering the constraints and features of these devices. Mobile devices run on battery and have less powerful processors.”</p>
                            </div>
                            <div class="testimonial-slide-meta">
                                <img src="./Home 2 _ Appiyan - App Landing Page_files/testimonial-slide-meta3.png" alt="">
                                <span class="testimonial-meta">
                        ...
                        </div></div><div class="owl-item" style="width: 356.667px; margin-right: 20px;"><div class="testimonial-single-slide">
                            <div class="testimonial-slide-content">
                                <p>“Developing apps for mobile devices requires considering the constraints and features of these devices. Mobile devices run on battery and have less powerful processors.”</p>
                            </div>
                            <div class="testimonial-slide-meta">
                                <img src="./Home 2 _ Appiyan - App Landing Page_files/testimonial-slide-meta1.png" alt="">
                                <span class="testimonial-meta">
                        ...
                        </div></div><div class="owl-item active" style="width: 356.667px; margin-right: 20px;"><div class="testimonial-single-slide">
                            <div class="testimonial-slide-content">
                                <p>“Developing apps for mobile devices requires considering the constraints and features of these devices. Mobile devices run on battery and have less powerful processors.”</p>
                            </div>
                            <div class="testimonial-slide-meta">
                        ...
                        </div></div><div class="owl-item cloned active" style="width: 356.667px; margin-right: 20px;"><div class="testimonial-single-slide">
                            <div class="testimonial-slide-content">
                                <p>“Developing apps for mobile devices requires considering the constraints and features of these devices. Mobile devices run on battery and have less powerful processors.”</p>
                            </div>
                            <div class="testimonial-slide-meta">
                        ...
                        </div></div></div></div><div class="owl-controls">
                            <div class="owl-nav"><div class="owl-prev" style="display: none;">prev
                            </div><div class="owl-next" style="display: none;">next</div></div>
                            <div class="owl-dots" style=""><div class="owl-dot"><span></span></div><div class="owl-dot active"><span></span></div></div></div></div>
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col- col-md-12">
                    <div class="blog-slide owl-carousel owl-theme owl-responsive-992 owl-loaded">
                    ...
                    <div class="owl-stage-outer"><div class="owl-stage" style="transform: translate3d(-2636.67px, 0px, 0px); transition: all 0.25s ease 0s; width: 4896.67px;"><div class="owl-item cloned" style="width: 356.667px; margin-right: 20px;"><div class="blog-single-slide">
