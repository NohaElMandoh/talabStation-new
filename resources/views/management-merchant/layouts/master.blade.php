...
<body>
    <div class="app-container app-theme-gray">
        <div class="app-main">
           @include('management-merchant.partials.side-bar')
            ...
            <div class="app-main__outer">
                <div class="app-main__inner">
                    ...
                    @include('management-merchant.partials.header')

                    <div class="app-inner-layout app-inner-layout-page">
                      @include('management-merchant.partials.nav-bar')
            ...
            @include('management-merchant.partials.footer')
        </div>
    </div>
    @include('management-merchant.partials.drawer')

    @include('management-merchant.partials.scripts')
    @yield('scripts')
