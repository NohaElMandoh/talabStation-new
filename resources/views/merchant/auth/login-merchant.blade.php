<!DOCTYPE html>
<!-- saved from url=(0069)https://demo.dashboardpack.com/kero-html-sidebar-pro/pages-login.html -->
<html lang="en">
...
<head>
    ...
    <!-- <link href="./Login - Kero HTML Bootstrap 4 Dashboard Template_files/main.07a59de7b920cd76b874.css" rel="stylesheet"> -->
    <link rel="stylesheet" href="{{ asset('Dashboard-UI/css/main.07a59de7b920cd76b874.css') }}" />
    <style>
        @charset "UTF-8";
...
<body>
            ...
            <div class="h-100">
                <div class="h-100 no-gutters row">
                    ...
                    <!--    <div class="slider-light">
                            <div class="slick-slider slick-initialized slick-dotted"><button class="slick-prev slick-arrow" aria-label="Previous" type="button" style="">Previous</button>
                                <div class="slick-list draggable">
                                    <div class="slick-track" style="opacity: 1; width: 3738px; transform: translate3d(-534px, 0px, 0px);">
                                        <div class="slick-slide slick-cloned" data-slick-index="-1" aria-hidden="true" tabindex="-1" style="width: 534px;">
                                            <div>
                                                <div style="width: 100%; display: inline-block;">
                                                    <div class="h-100 d-flex justify-content-center align-items-center bg-sunny-morning" tabindex="-1">
                                                        <div class="slide-img-bg" style="background-image: url(public/uploads/login/Mak_Home_Ordering.png);"></div>
                                        ...
                                        <div class="slick-slide slick-current slick-active" data-slick-index="0" aria-hidden="false" role="tabpanel" id="slick-slide00" style="width: 534px;">
                                            <div>
                                                <div style="width: 100%; display: inline-block;">
                                                    <div class="h-100 d-flex justify-content-center align-items-center bg-plum-plate" tabindex="-1">
                                                        ...
                                                        <div class="slider-content">
                                                            ...
                                                            <p>KeroUI is like a dream. Some think it's too good to be true! Extensive collection of unified React Boostrap Components and Elements.</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="slick-slide" data-slick-index="1" aria-hidden="true" tabindex="-1" role="tabpanel" id="slick-slide01" style="width: 534px;">
                                            <div>
                                                <div style="width: 100%; display: inline-block;">
                                        ...
                                        <div class="slick-slide" data-slick-index="2" aria-hidden="true" tabindex="-1" role="tabpanel" id="slick-slide02" style="width: 534px;">
                                            <div>
                                                <div style="width: 100%; display: inline-block;">
                                                    <div class="h-100 d-flex justify-content-center align-items-center bg-sunny-morning" tabindex="-1">
                                        ...
                                        <div class="slick-slide slick-cloned" data-slick-index="3" aria-hidden="true" tabindex="-1" style="width: 534px;">
                                            <div>
                                                <div style="width: 100%; display: inline-block;">
                                                    <div class="h-100 d-flex justify-content-center align-items-center bg-plum-plate" tabindex="-1">
                                        ...
                                        <div class="slick-slide slick-cloned" data-slick-index="4" aria-hidden="true" tabindex="-1" style="width: 534px;">
                                            <div>
                                                <div style="width: 100%; display: inline-block;">
                                                    <div class="h-100 d-flex justify-content-center align-items-center bg-premium-dark" tabindex="-1">
                                                        <div class="slide-img-bg" style="background-image: url(&#39;assets/images/originals/citynights.jpg&#39;);"></div>
                                        ...
                                        <div class="slick-slide slick-cloned" data-slick-index="5" aria-hidden="true" tabindex="-1" style="width: 534px;">
                                            <div>
                                                <div style="width: 100%; display: inline-block;">
                                                    <div class="h-100 d-flex justify-content-center align-items-center bg-sunny-morning" tabindex="-1">
                                                        <div class="slide-img-bg" style="background-image: url(&#39;assets/images/originals/citydark.jpg&#39;);"></div>
                            ...
                            <label for="password" class="">Password</label>
                                ...
                                @endif
                                    ...
                                    <div class="d-flex align-items-center">
                                        <div class="ml-auto">
                                            <a href="{{ url('/password/reset') }}" class="btn-lg btn btn-link"> Forgot Your Password?</a>
    ...
    <script type="text/javascript" src="{{asset('Dashboard-UI/js/main.07a59de7b920cd76b874.js.download')}}"></script>
