        ...
        <div class="col-md-12">
            <div class="main-card mb-3 card">
                <div class="card-body">
                    ...
                    <form action="{{ url('merchant/filter') }}" method="GET">
                        {{ csrf_field() }}
                        <div class="form-row">
                            @if ($errors->any())
                                                ...
                                                <td>
                                                    ...
                                                    @if ($o->state == 'pending')
                                                        <a href="javascript:void(0);"
                                                            onclick="acceptOrder({{ $o->id }});" title="قبول الطلب"
                                                            class="btn btn-success  ">
                                                            قبول
                                                        </a>
                                                        <button type="button" class="btn btn-danger " id="rej_btn"
                                                            data-id="{{ $o->id }}" data-toggle="modal"
                                                            data-target="#rejectOrderReason" >رفض</button>
                                                        {{-- <a href="javascript:void(0);" onclick="rejectOrder({{$o->id}});" title="رفض الطلب" class="btn btn-danger " >
                                                رفض
                                            </a> --}}
                    ...
                    <form id="add_form">
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label for="name" class="col-form-label"><span style="color: red;">*</span>سبب الغاء الطلب</label>
